...
class Kissmanga_Comic:
    '''Collection of functions that allow to download a 
    kissmanga.com comic with all it's issues.'''
    ...
    def get_comic_and_issue_name(self, issue_link):
        ...
        generic_comic_name = re.compile(r"(?<=Manga/)(.+?)/(.+?)(?=\?)", re.I)
    ...
    def get_issues_links(self):
        ...
        try:
            ...
            core_link = "https://kissmanga.com"
            generic_link = re.compile(r'(?<=")/Manga/.+?id=\d+(?=")', re.I)
